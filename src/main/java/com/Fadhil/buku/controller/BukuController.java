 ...
 */
package com.Fadhil.buku.controller;

import com.Fadhil.buku.entity.Buku;
import com.Fadhil.buku.service.BukuService;
...
public class BukuController {
    ...
    @DeleteMapping("/{id}")
    public void deleteById(@PathVariable("id")Long bukuId){
        bukuService.deleteById(bukuId);
    }
}
